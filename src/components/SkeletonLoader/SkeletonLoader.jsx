  ...
  return (
    <div className="md:grid md:grid-cols-12 gap-4 md:items-start">
      <div className="md:col-span-4">
        <section className="bg-white dark:bg-indigo-900 md:p-4 md:px-8 rounded-xl my-2">
          <div className="animate-pulse">
            <div className="rounded-xl bg-slate-200 dark:bg-blue-950 h-96"></div>
          </div>
          <div className="animate-pulse my-4">
            <div className="rounded-xl bg-slate-200 dark:bg-blue-950 h-20"></div>
          </div>
        </section>
      </div>
